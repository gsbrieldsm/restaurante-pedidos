    ...
    <div className="min-h-screen font-sans" style={{ background: '#ffffff', color: '#0d1a18' }}>
      ...
      <style>{`
        ...
        .teal-mist-hero {
          background-color: #ffffff;
          background-image:
            radial-gradient(ellipse 65% 70% at 90% 10%, rgba(26,155,138,0.22) 0%, transparent 60%),
            radial-gradient(ellipse 50% 60% at 5%  80%, rgba(26,155,138,0.15) 0%, transparent 55%),
            radial-gradient(ellipse 40% 50% at 60% 90%, rgba(26,155,138,0.13) 0%, transparent 50%),
            linear-gradient(rgba(26,155,138,.11) 1px, transparent 1px),
            linear-gradient(90deg, rgba(26,155,138,.11) 1px, transparent 1px);
          background-size: auto, auto, auto, 48px 48px, 48px 48px;
        }
        .teal-mist-section {
          background-color: #ffffff;
          background-image:
            radial-gradient(ellipse 70% 60% at 0% 50%,   rgba(26,155,138,0.17) 0%, transparent 60%),
            radial-gradient(ellipse 50% 50% at 100% 50%, rgba(26,155,138,0.13) 0%, transparent 55%),
            linear-gradient(rgba(26,155,138,.10) 1px, transparent 1px),
            linear-gradient(90deg, rgba(26,155,138,.10) 1px, transparent 1px);
